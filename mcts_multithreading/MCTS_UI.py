...
class BoardGameCanvas(tkinter.Canvas):
    ...
    def __init__(self, game_board, ai, parent=None):
        ...
        tkinter.Canvas.__init__(self, parent, width=self._width, height=self._height, bg='#A0522D')
    ...
    def draw_grid(self):
        ...
        for y in self._row_grid:
            self.create_line(left, y, right, y, fill='#000000', width=5)
        for x in self._col_grid:
            self.create_line(x, lower, x, upper, fill='#000000', width=5)
